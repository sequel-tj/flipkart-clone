...
const CustomButtons = () => {
    ...
    return (
        <ThemeProvider theme={customTheme}>
            <Box css={Component}>
                <Box css={wrapper}>
                    <Box style={{ display: "flex", justifyContent: "space-between", alignItems: 'center', textAlign: 'center', cursor: 'pointer' }}>
                        <img style={{ marginRight: 10 }} src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/Store-9eeae2.svg" alt="seller" />
...

                    {
                        account ? <Profile account={account} setAccount={setAccount} /> :
                            ...
                            <Box css={userbtn} onClick={openDialog} style={{ padding: "8px", display: "flex", justifyContent: "space-between", alignItems: 'center', textAlign: 'center', cursor: 'pointer' }}>
                                ...
                                {/* <img style={{ marginRight: 10 }} src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/profile-815786.svg" alt="user" /> */}
                                <Typography style={{marginLeft: 10, cursor: 'pointer' }}>Login</Typography>
                            </Box>
                    }
                    ...
                    <Link to="/cart" css={container} style={{ cursor: 'pointer' }}>
                        <img style={{ marginRight: 10 }} src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/header_cart-eed150.svg" alt="cart" />
